---
name: mppm_clone_list
old_tool: mppm_clone_list
request_type: mppmCloneList
description: "Detect MPPM presence (Window > Multiplayer Play Mode for clone listing)."
...
try
{
    ...
    return new { success = true, mppmInstalled = mppmType != null, note = "Use Window > Multiplayer Play Mode for clone listing." };
}
